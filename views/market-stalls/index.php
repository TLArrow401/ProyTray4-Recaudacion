...
$result = $marketStallsController->index($params);
...
$market_stalls = $result['market_stalls'] ?? [];
$total_items = $result['total_items'] ?? 0;
$total_pages = $result['total_pages'] ?? 1;
$current_page = $result['current_page'] ?? 1;
$search = $result['search'] ?? '';
$page_title = $result['page_title'] ?? 'Locales de Mercado';
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title">
                            <i class="ri ri-store-2-line mr-1"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <form method="GET" action="index.php" class="d-flex">
                                    <input type="text" 
                                           ...
                                           placeholder="Buscar por número, ubicación, sector o zona..." 
                            ...
                            <div class="col-md-6 text-right">
                                <small class="text-muted">
                                    Total: <?php echo number_format($total_items); ?> locales
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive mb-4">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($market_stalls as $stall): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($stall['id']); ?></td>
                                        <td>
                                            <span class="badge text-bg-info">
                                                <?php echo htmlspecialchars($stall['zone_name'] ?? 'N/A'); ?>
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge text-bg-primary">
                                                <?php echo htmlspecialchars($stall['sector_name'] ?? 'N/A'); ?>
                                            </span>
                                        </td>
                                        <td>
                                            <strong><?php echo htmlspecialchars($stall['stall_number']); ?></strong>
                                        </td>
                                        <td>
                                            <?php if (!empty($stall['location_description'])): ?>
                                                <?php echo htmlspecialchars(substr($stall['location_description'], 0, 50)); ?>
                                                <?php if (strlen($stall['location_description']) > 50): ?>...<?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="view.php?id=<?php echo $stall['id']; ?>" 
                                                   class="btn btn-sm btn-outline-info" 
                                                   title="Ver detalles">
                                                    <i class="ri ri-eye-line"></i>
                                                </a>
                                                <a href="edit.php?id=<?php echo $stall['id']; ?>" 
                                                ...
                                                <button type="button" 
                                                        ...
                                                        title="Eliminar"
                                                        onclick="confirmDelete(<?php echo $stall['id']; ?>, '<?php echo htmlspecialchars($stall['stall_number'], ENT_QUOTES); ?>')">
                        ...
                        <div class="text-center py-4">
                            <div class="mb-3">
                                <i class="ri ri-store-2-line" style="font-size: 48px; color: #6c757d;"></i>
                            </div>
                            <h5 class="text-muted">No se encontraron locales</h5>
                            <p class="text-muted">
                                <?php if (!empty($search)): ?>
                                ...
                                <?php else: ?>
                                Comienza creando tu primer local de mercado
                                <br>
