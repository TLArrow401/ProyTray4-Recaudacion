...
try {
    // Obtener sectores por zona usando el controlador
    $result = $contractsController->getSectorsByZone($input['zone_id']);
    
    // Retornar resultado
    echo json_encode($result);
    
} catch (Exception $e) {
    error_log("Error obteniendo sectores por zona: " . $e->getMessage());
