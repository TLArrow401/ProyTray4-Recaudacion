...
$result = $zonesController->index($params);
...
$page_title = $result['page_title'] ?? 'Zonas de Mercado';
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title">
                            <i class="ri ri-map-2-line mr-1"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 text-right">
                                <small class="text-muted">
                                    Total: <?php echo number_format($total_items); ?> zonas
                                </small>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($zone['description'])): ?>
                                                <?php echo htmlspecialchars(substr($zone['description'], 0, 100)); ?>
                                                <?php if (strlen($zone['description']) > 100): ?>...<?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="view.php?id=<?php echo $zone['id']; ?>" 
                                                   class="btn btn-sm btn-outline-info" 
                                                   title="Ver detalles">
                                                    <i class="ri ri-eye-line"></i>
                                                </a>
                                                <a href="edit.php?id=<?php echo $zone['id']; ?>" 
                                                ...
                                                <button type="button" 
                                                        ...
                                                        title="Eliminar"
                                                        onclick="confirmDelete(<?php echo $zone['id']; ?>, '<?php echo htmlspecialchars($zone['name'], ENT_QUOTES); ?>')">
                        ...
                        <div class="text-center py-4">
                            <div class="mb-3">
                                <i class="ri ri-map-2-line" style="font-size: 48px; color: #6c757d;"></i>
                            </div>
                            <h5 class="text-muted">No se encontraron zonas</h5>
                            <p class="text-muted">
                                <?php if (!empty($search)): ?>
                                ...
                                <?php else: ?>
                                Comienza creando tu primera zona de mercado
                                <br>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-muted">Esta acción no se puede deshacer y también eliminará todos los sectores asociados.</p>
            </div>
