...
$result = $externalItemsController->view(['id' => $id]);
...
$external_item = $result['external_item'] ?? null;
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="row g-2">
                                    ...
                                    <div class="col-sm-9">
                                        <?php echo htmlspecialchars($external_item['id']); ?>
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                        <?php echo htmlspecialchars($external_item['name']); ?>
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                        <?php if (!empty($external_item['installation_type'])): ?>
                                            <span class="badge badge-info">
                                                <?php echo htmlspecialchars($external_item['installation_type']); ?>
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <div class="col-sm-9">
                                        <?php if (!is_null($external_item['payment_count'])): ?>
                                            <?php echo number_format($external_item['payment_count'], 2); ?>
                                        <?php else: ?>
                                            <span class="text-muted">No especificado</span>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div class="text-center py-4">
                            ...
                            <h5 class="text-muted">Rubro Externo no encontrado</h5>
                            <p class="text-muted">
                                El rubro externo que buscas no existe o ha sido eliminado.
                                <br>
