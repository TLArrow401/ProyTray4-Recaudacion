...
$result = $internalItemsController->index($params);
...
$internal_items = $result['internal_items'] ?? [];
$total_items = $result['total_items'] ?? 0;
$total_pages = $result['total_pages'] ?? 1;
$current_page = $result['current_page'] ?? 1;
$search = $result['search'] ?? '';
$page_title = $result['page_title'] ?? 'Rubros Internos';
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title">
                            <i class="ri ri-list-check mr-1"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 text-right">
                                <small class="text-muted">
                                    Total: <?php echo number_format($total_items); ?> rubros internos
                                </small>
                            </div>
                        </div>
                        ...
                        <!-- Tabla de rubros internos -->
                        <?php if (!empty($internal_items)): ?>
                        <div class="table-responsive mb-4">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($internal_items as $item): ?>
                                    <tr>
                        ...
                        <div class="text-center py-4">
                            <div class="mb-3">
                                <i class="ri ri-file-list-line" style="font-size: 48px; color: #6c757d;"></i>
                            </div>
                            <h5 class="text-muted">No se encontraron rubros internos</h5>
                            <p class="text-muted">
                                <?php if (!empty($search)): ?>
                                No se encontraron resultados para "<?php echo htmlspecialchars($search); ?>"
                                <br>
                                <a href="index.php" class="btn btn-outline-primary mt-2">
                                    Ver todos los rubros internos
                                </a>
                                <?php else: ?>
                                Comienza creando tu primer rubro interno
                                <br>
